...
> 본사와 지점을 연결하는 제로로스 직영점 운영 관리 시스템

📅 개발 기간 : 2025.03.10 ~ 2025.05.12  
👨‍👩‍👧‍👦 팀원 : 5명
...
**ZEROLOSS ERP**는  
직영점 운영 전반을 관리하기 위한 **본사-지점 통합 ERP 시스템**입니다.
...
| 이름 | 역할 | 담당 업무 |
|---|---|---|
| 표승혁 | 팀장 / ERP | PM 및 일정관리, 본사/지점 매출관리, 본사/지점 레시피 관리, 본사/지점 공지&문의사항, 본사 직영점 관리, 본사 배송관리, 지점 간 재고 스왑 |
| 최승우 | 팀원 / ERP | 지점 발주 요청, 본사 발주 승인, 본사 반려 처리, 본사 물류창고 입/출고, 지점 재고 입고 |
| 서지은 | 팀원 / ERP | 공통 로그인, 본사/지점 메인 페이지, 본사/지점 알림, 본사/지점 직원관리, ERP 본사 권한 관리 |
| 이규윤 | 팀원 / 키오스크+ERP | 키오스크 메뉴 페이지, 키오스크 옵션 선택 페이지, 키오스크 주문 확인 페이지, 키오스크 장바구니, ERP 본사 지점 재고 및 리스크 현황 |
| 곽주영 | 팀원 / 키오스크+ERP | 키오스크 테스트 화면, 키오스크 주문 방식, 키오스크 결제/결제승인, 키오스크 영수증/주문완료, ERP 지점 재고 현황 및 변동 |
...
![본사 메인](https://github.com/user-attachments/assets/c53dfbdc-32b6-41b6-8a8a-608a5171d531)

## 본사 매출 조회

![본사 매출 조회](https://github.com/user-attachments/assets/edc8dc9d-8cb8-4200-abc7-01bcb128d5b5)

## 지점 메인

![지점 메인](https://github.com/user-attachments/assets/e8323614-204f-40f7-9b84-425feb59a1f1)

## 지점 발주 생성

![지점 발주 생성](https://github.com/user-attachments/assets/6c1124e0-550d-49e2-a493-d9ccec5c785d)

## 지점 재고관리

![지점 재고관리](https://github.com/user-attachments/assets/a3d10778-2c42-430b-a4fc-a919ba3740a5)

## 지점 재고 스왑

![지점 재고 스왑](https://github.com/user-attachments/assets/ca396019-3323-46d6-8d89-8c2e396c2278)
