...
@WebServlet("/hq/sales/daily")
public class HqDailySalesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<DailySalesDTO> dailySales = hqSalesService.getDailySales(branchCodeParam, targetDate);
            ...
            response.getWriter().write("{\"error\": \"일별 매출 데이터를 조회하는 중 오류가 발생했습니다.\"}");
        }
    }
}
