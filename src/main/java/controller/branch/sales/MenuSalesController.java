...
@WebServlet("/branch/sales/menu")
public class MenuSalesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<MenuSalesDTO> menuSales = salesService.getMenuSales(branchCode, targetDate);
            ...
            response.setContentType("application/json");
            response.setCharacterEncoding("UTF-8");
            response.getWriter().write("{\"error\": \"메뉴별 매출 데이터를 조회하는 중 서버 오류가 발생했습니다.\"}");
        }
    }
}
