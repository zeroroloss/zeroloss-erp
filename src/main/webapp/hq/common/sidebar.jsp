		    ...
		    <div class="p-6 border-b border-gray-200">
				...
				<nav class="flex-1 p-4 space-y-1 overflow-y-auto">
				    ...
				    <div class="submenu <%= supportGroup ? "" : "hidden" %> ml-4 mt-1 space-y-1">
				        ...
				        <a href="<%= cp %>/hq/support/headquarters-inquiries.jsp" class="block px-4 py-2 rounded-lg text-sm <%= hqInquiriesActive ? "bg-[#00853D] text-white font-medium" : "text-gray-600 hover:bg-gray-100" %>">문의사항</a>
				    </div>
