        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="workType" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00853D] focus:border-transparent">
            ...
            <div>
                ...
                <select id="isRepeat" onchange="toggleRepeatOptions()"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00853D] focus:border-transparent">
            ...
            <div>
                ...
                <textarea id="memo" placeholder="추가 정보나 특이사항을 입력하세요..."
