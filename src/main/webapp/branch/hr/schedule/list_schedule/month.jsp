      ...
      <div class="wrap">
        ...
        <section class="cal-wrap">
          <div class="cal-top">
            ...
            <div class="view-tabs"><a class="active" href="<%= request.getContextPath() %>/branch/hr/schedule/list_schedule/month.jsp">월</a><a href="<%= request.getContextPath() %>/branch/hr/list_schedule/week.jsp">주</a><a href="<%= request.getContextPath() %>/branch/hr/list_schedule/day.jsp">일</a></div>
          </div>
