...
<head>
  ...
  <style>
    ...
    .week-row .cell { min-height: 110px; border-top: 1px solid #e5e7eb; border-right: 1px solid #e5e7eb; padding: 10px; font-size: 15px; }
    ...
    .evt { margin-top: 14px; border-radius: 6px; padding: 4px 6px; font-size: 11px; background: #2f7ded; color: #fff; }
    .evt .line1 { font-weight: 700; }
    .evt .line2 { opacity: 0.95; }
    @media (max-width: 760px) {
      .title { font-size: 28px; } .sub { font-size: 14px; } .stats { grid-template-columns: 1fr; }
