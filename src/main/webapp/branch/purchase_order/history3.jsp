...
<head>
    ...
    width: 100%; max-width: none; margin: 0; }
        ...
        .tab-link.active { background: #fff1f2; box-shadow: inset 0 -2px 0 #ef4444; }
        ...
        tr.row-rejected { background: #fff7f7; }
...
<div class="wrap">
    ...
    <div class="table-card">
        <div class="tabs">
            ...
            <a class="tab-link rejected active" href="/branch/purchase_order/history3.jsp">반려 (1)</a>
        </div>
