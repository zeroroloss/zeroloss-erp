...
<head>
    ...
    width: 100%; max-width: none; margin: 0; }
        ...
        .tab-link { height: 52px; display: flex; align-items: center; justify-content: center; text-decoration: none; background: #fff; font-size: 16px; font-weight: 700; letter-spacing: -0.01em; color: #6b7280; }
        ...
        @media (max-width: 980px) {
            ...
            .status { font-size: 11px; }
            .work { font-size: 12px; margin-right: 8px; }
        }
    </style>
...
<div class="wrap">
    ...
    <div class="table-card">
        <div class="tabs">
            <a class="tab-link active" href="<%= request.getContextPath() %>/branch/purchase_order/history.jsp">전체 (5)</a>
            <a class="tab-link sent" href="<%= request.getContextPath() %>/branch/purchase_order/history1.jsp">전송 (2)</a>
            <a class="tab-link approved" href="<%= request.getContextPath() %>/branch/purchase_order/history2.jsp">승인 (2)</a>
            <a class="tab-link rejected" href="<%= request.getContextPath() %>/branch/purchase_order/history3.jsp">반려 (1)</a>
        </div>
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a class="mono-link open-purchase-popup" href="/branch/purchase_order/approval_detail.jsp">PO-2026-0328-001</a></td>
                        <td>📅 2026-03-28 14:20</td>
                        <td class="right value-strong">5개</td>
                        <td class="right value-blue">250</td>
                        <td class="center"><span class="status approved">◌ 승인</span></td>
                        <td class="center"><a class="work view open-purchase-popup" href="/branch/purchase_order/approval_detail.jsp">◎ 상세</a></td>
                    </tr>
                    <tr>
                        <td><a class="mono-link open-purchase-popup" href="/branch/purchase_order/approval_detail.jsp">PO-2026-0327-003</a></td>
                        <td>📅 2026-03-27 16:45</td>
                        <td class="right value-strong">6개</td>
                        <td class="right value-blue">310</td>
                        <td class="center"><span class="status approved">◌ 승인</span></td>
                        <td class="center"><a class="work view open-purchase-popup" href="/branch/purchase_order/approval_detail.jsp">◎ 상세</a></td>
                    </tr>
                    <tr class="row-rejected">
                        <td><a class="mono-link open-purchase-popup" href="/branch/purchase_order/rejection_detail.jsp">PO-2026-0327-002</a></td>
                        <td>📅 2026-03-27 11:00</td>
                        <td class="right value-strong">4개</td>
                        <td class="right value-blue">180</td>
                        <td class="center"><span class="status rejected">⊗ 반려</span></td>
                        <td class="center"><a class="work view open-purchase-popup" href="/branch/purchase_order/rejection_detail.jsp">◎ 상세</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
