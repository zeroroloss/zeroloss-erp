...
<head>
    ...
    width: 100%; max-width: none; margin: 0; }
        ...
        .tab-link.active { background: #ecf8f0; box-shadow: inset 0 -2px 0 #22c55e; }
...
<div class="wrap">
    ...
    <div class="table-card">
        <div class="tabs">
            ...
            <a class="tab-link sent" href="/branch/purchase_order/history1.jsp">전송 (2)</a>
            <a class="tab-link approved active" href="/branch/purchase_order/history2.jsp">승인 (2)</a>
