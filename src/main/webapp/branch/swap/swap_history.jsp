...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;}body{margin:0;font-family:"Noto Sans KR","Malgun Gothic",sans-serif;background:var(--bg);color:var(--text);} .wrap{
    ...
    .filter{margin-top:14px;background:#fff;border:1px solid var(--line);border-radius:14px;padding:16px 18px;} .f-title{font-size:24px;font-weight:800;margin:0 0 10px;} .row{display:grid;grid-template-columns:1fr 1fr;gap:12px;}
    .label{font-size:14px;font-weight:700;color:#374151;display:block;margin-bottom:6px;} .input{width:100%;height:44px;border:1px solid #cfd6dd;border-radius:12px;padding:0 12px;font-size:14px;}
    ...
    table{width:100%;border-collapse:collapse;} th,td{padding:12px 16px;border-bottom:1px solid #e5e7eb;font-size:14px;} th{background:#f9fafb;text-align:left;color:#374151;font-weight:700;} td:nth-child(5),th:nth-child(5),td:nth-child(6),th:nth-child(6){text-align:center;}
    .badge-state{display:inline-block;padding:4px 10px;border-radius:999px;font-size:12px;font-weight:700;background:#dcfce7;color:#15803d;}
    .info{margin-top:14px;background:#eff6ff;border:1px solid #bfdbfe;border-radius:14px;padding:14px 16px;} .info h4{margin:0;font-size:16px;color:#1e3a8a;} .info p{margin:8px 0 0;font-size:13px;color:#1e40af;line-height:1.6;}
    @media (max-width:1280px){.title{font-size:40px}.sub{font-size:24px}.tab{font-size:16px;height:44px}.f-title,.panel-title{font-size:24px}.panel-sub{font-size:16px}.label,.input,th,td{font-size:14px}.badge-state{font-size:12px}.info h4{font-size:16px}.info p{font-size:13px}.stats{grid-template-columns:repeat(2,1fr)}.stat .n{font-size:28px}.stat .l{font-size:13px}}
  </style>
...
<main class="zl-page"><div class="wrap">
  ...
  <nav class="tabs">
    ...
    <a class="tab active" href="<%= request.getContextPath() %>/branch/swap/swap_history.jsp"><img class="tab-ico" src="<%= request.getContextPath() %>/branch/icons/swap/history.svg" alt="">교환 내역</a>
  </nav>
  ...
  <section class="panel">
    ...
    <table>
      ...
      <tbody>
        <tr><td>2026-03-28</td><td>강남점</td><td>홍대점</td><td>치킨 패티</td><td>30개</td><td><span class="badge-state">완료</span></td></tr>
        <tr><td>2026-03-25</td><td>신촌점</td><td>강남점</td><td>양상추</td><td>10kg</td><td><span class="badge-state">완료</span></td></tr>
        <tr><td>2026-03-20</td><td>홍대점</td><td>신촌점</td><td>소고기 패티</td><td>15개</td><td><span class="badge-state">완료</span></td></tr>
      </tbody>
    </table>
  </section>
